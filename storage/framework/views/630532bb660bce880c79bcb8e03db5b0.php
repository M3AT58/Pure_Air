...
<?php $__env->startSection('title', __('messages.add_new_service')); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <label for="short_description" class="form-label"><?php echo e(__('messages.short_description')); ?> *</label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" 
                                               name="is_active" value="1" <?php echo e(old('is_active') ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="meta_title" class="form-label"><?php echo e(__('messages.meta_title')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <label for="meta_description" class="form-label"><?php echo e(__('messages.meta_description')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <label for="meta_keywords" class="form-label"><?php echo e(__('messages.meta_keywords')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="full_description" class="form-label"><?php echo e(__('messages.full_description')); ?> *</label>
...
unset($__errorArgs, $__bag); ?>" 
                                              id="full_description" name="full_description" rows="6" required><?php echo e(old('full_description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\M3AT58\Desktop\Pure_Air\resources\views/admin/services/create.blade.php ENDPATH**/ ?>