...
<?php $__env->startSection('title', 'من نحن - بيور إير'); ?>
<?php $__env->startSection('meta_description', 'تعرف على بيور إير ومهمتنا في تقديم خدمات مكافحة الحشرات وعزل وتعقيم الخزانات ونظافة وصيانة المكيفات.'); ?>
<?php $__env->startSection('meta_keywords', 'من نحن بيور إير، شركة مكافحة الحشرات، متخصصو صيانة الخزانات، صيانة المكيفات'); ?>
...
<div class="bg-primary text-white py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <h1 class="display-4 fw-bold mb-3"><?php echo e(__('messages.about_title')); ?></h1>
                <p class="lead mb-0"><?php echo e(__('messages.about_subtitle')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<section class="py-5">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <h2 class="display-5 fw-bold text-primary mb-4"><?php echo e(__('messages.our_mission')); ?></h2>
                <p class="lead mb-4"><?php echo e(__('messages.mission_text')); ?></p>
            ...
            <div class="col-lg-6 text-center">
                <div class="bg-light rounded p-5">
                    ...
                    <h4 class="text-primary mt-3"><?php echo e(__('messages.comprehensive_protection')); ?></h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="display-5 fw-bold text-primary mb-3"><?php echo e(__('messages.our_values')); ?></h2>
                <p class="lead text-muted"><?php echo e(__('messages.values_text')); ?></p>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <h5 class="fw-bold mb-3"><?php echo e(__('messages.quality_assurance')); ?></h5>
                ...
                <div class="bg-white rounded p-5 text-center shadow-sm">
                    <div class="row text-center">
                        <div class="col-6 mb-4">
                            ...
                            <p class="text-muted"><?php echo e(__('messages.satisfied_customers')); ?></p>
                        </div>
                        <div class="col-6 mb-4">
                            <h3 class="display-4 fw-bold text-primary">10+</h3>
                            <p class="text-muted"><?php echo e(__('messages.years_experience')); ?></p>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <p class="text-muted"><?php echo e(__('messages.emergency_service')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <h2 class="display-5 fw-bold text-primary mb-4"><?php echo e(__('messages.why_choose_us')); ?></h2>
                <div class="mb-4">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-start">
                ...
                <a href="tel:<?php echo e(\App\Models\Setting::get('contact_phone', '+966-555-PURE-AIR')); ?>" class="btn btn-outline-light btn-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\M3AT58\Desktop\Pure_Air\resources\views/pages/about.blade.php ENDPATH**/ ?>