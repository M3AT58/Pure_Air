...
<?php $__env->startSection('title', __('messages.add_new_post')); ?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4><?php echo e(__('messages.add_new_post')); ?></h4>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="published" <?php echo e(old('status') == 'published' ? 'selected' : ''); ?>><?php echo e(__('messages.published')); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <label for="published_at" class="form-label"><?php echo e(__('messages.published_at')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="excerpt" class="form-label"><?php echo e(__('messages.excerpt')); ?> *</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="body" class="form-label"><?php echo e(__('messages.body')); ?> *</label>
...
unset($__errorArgs, $__bag); ?>" 
                                              id="body" name="body" rows="8" required><?php echo e(old('body')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\M3AT58\Desktop\Pure_Air\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>