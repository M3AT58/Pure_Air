...
@section('title', __('messages.edit') . ' - ' . $post->title)
                ...
                <div class="card-body">
                    <form action="{{ route('admin.posts.update', $post) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="draft" {{ old('status', $post->status) == 'draft' ? 'selected' : '' }}>{{ __('messages.draft') }}</option>
                                        <option value="published" {{ old('status', $post->status) == 'published' ? 'selected' : '' }}>{{ __('messages.published') }}</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <label for="published_at" class="form-label">{{ __('messages.published_at') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="body" class="form-label">{{ __('messages.body') }} *</label>
